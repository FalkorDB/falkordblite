...
1. Download and compile Redis from source (version 8.6.2)
2. Download the FalkorDB module (version v4.18.3)
...
- `REDIS_VERSION`: Redis version to use (default: 8.6.2)
- `FALKORDB_VERSION`: FalkorDB module version (default: v4.18.3)
